...
<body>
	...
	<div class="main_top">
		...
		<div class="edit_content">
			<form action="${ctx }/GoodsServlet?action=editGoods" method="post"
				...
				<div class="item1">
					<div>
						<span>所属分类：</span> <select id="categorySel" name="cid">
					...
					<div>
						<span>是否热门：</span> <select id="isHotSel" name="is_hot">
